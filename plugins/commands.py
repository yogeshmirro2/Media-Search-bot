...
async def search(bot, message):
    ...
    try:
        ...
        if len(files)>=1:
            ...
            spelling चेक करने के लिए आप google की सहायता ले सकते है \कृपया send bhejo season जैसे शब्दों का प्रयोग न करे (webseries search करने के लिए आप S01 या S01E01 का प्रयोग कर सकते है जैसे :- Panchayat S01 )\nकिसी अन्य सहायता के लिए आप [BOT_ADMIN](tg://user?id={Config.BOT_ADMINS[0]}) पर सम्पर्क कर कर सकते है",reply_markup = btn)
    except Exception as e:
